...
QT_MOC_LITERAL(1, 11, 14), // "recognize_bool"
QT_MOC_LITERAL(2, 26, 0) // ""

    },
    "WorkThread\0recognize_bool\0"
};
...
void WorkThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->recognize_bool((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkThread::recognize_bool)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WorkThread::recognize_bool(int _t1)
{
